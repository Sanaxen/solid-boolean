...
void mlMatrix3x3::SetRotation(const mlQuaternion &orientation)
{
	...
	I.x = 1.0 - twoBsq - twoCsq;
	J.y = 1.0 - twoAsq - twoCsq;
	K.z = 1.0 - twoAsq - twoBsq;
